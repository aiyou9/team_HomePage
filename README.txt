...
此库基于2020年4月10日原项目github最新版(为了防查，具体来源看博客)，编译打包形成的静态网址文件，此库只作为 github page 和 下载部署到自己空间域名使用，（本库中已进行了{授权appID}的替换，需要替换文件，请到https://github.com/aiyou9/teamAPI）。
...
请打包下载https://github.com/aiyou9/teamAPI ，点击绿色图标code，下载zip压缩包。一样按照博客，进行之前的操作。
